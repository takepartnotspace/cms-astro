import type { Template, Collection } from 'tinacms';
import { tooltipTemplate } from '../../tina/config';
...
import { mitwirkendeBlockSchema } from '../../src/components/blocks/mitwirkende.template';
